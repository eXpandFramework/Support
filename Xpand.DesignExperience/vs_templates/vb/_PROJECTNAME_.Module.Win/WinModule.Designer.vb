...
#Region "Component Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        '
         Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.MasterDetail.MasterDetailModule))
		...
		Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.XtraDashboard.Win.DashboardWindowsFormsModule))
        ...
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.Scheduler.Win.XpandSchedulerWindowsFormsModule))
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.Chart.Win.XpandChartWinModule))
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.PivotGrid.Win.XpandPivotGridWinModule))
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.ReportsV2.Win.ReportsV2WinModule))
