...
<%@ Register Assembly="DevExpress.Web.v16.2" Namespace="DevExpress.Web"
    TagPrefix="dxrp" %>
                    ...
                    <td style="vertical-align: top">
                        <table id="MRC" style="width: 100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td id="separatorCell" style="width: 6px; border-bottom-style: none; border-top-style: none" class="dxsplVSeparator_<%= CurrentTheme %> dxsplPane_<%= CurrentTheme %>">
