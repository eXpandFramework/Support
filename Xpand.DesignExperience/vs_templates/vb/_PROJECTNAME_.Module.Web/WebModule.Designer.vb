...
#Region "Component Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.HtmlPropertyEditor.Web.XpandHtmlPropertyEditorAspNetModule))
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.Security.Web.XpandSecurityWebModule))
        Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.Scheduler.Web.XpandSchedulerAspNetModule))
		Me.RequiredModuleTypes.Add(GetType(Xpand.ExpressApp.FileAttachment.Web.XpandFileAttachmentsWebModule))
    End Sub
