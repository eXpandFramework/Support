...
namespace XpandTestExecutor.Module.Services {
    public static class TestUpdater {
        ...
        public static void IgnoreApplications(this EasyTest easyTest, LogTest[] logTests, string userName) {
            ...
            easyTest.SerializeOptions(userName);
        }
...
//                IngoreWebApplication(easyTestExecutionInfo.EasyTest);
                ...
                easyTestExecutionInfo.EasyTest.SerializeOptions(easyTestExecutionInfo.WindowsUser.Name);
            }
            else {
        ...
        private static void UpdatePort(EasyTestExecutionInfo easyTestExecutionInfo) {
            foreach (var application in easyTestExecutionInfo.EasyTest.Options.Applications.Cast<TestApplication>()) {
                ...
                if (additionalAttribute != null)
                    ...
                    additionalAttribute = application.AdditionalAttributes.FirstOrDefault(attribute => attribute.LocalName== "DontUseIIS");
                    if (additionalAttribute!=null&&additionalAttribute.Value=="True") {
                        additionalAttribute =
